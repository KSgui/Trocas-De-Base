...
document.addEventListener("DOMContentLoaded", function(){
    const magia = document.querySelectorAll('.informacoes2');

    function checkPosition() {
        for (let informacoes2 of magia) {
            if (informacoes2.getBoundingClientRect().top < window.innerHeight) {
                informacoes2.classList.add('visible');
            }
        }
    }
